...
class TestPasswordInput:
    ...
    def test_password_input_creation(self, app):
        ...
        assert password_input.line_edit.echoMode() == password_input.line_edit.EchoMode.Password
    ...
    def test_password_input_toggle_visibility(self, app):
        ...
        assert password_input.line_edit.echoMode() == password_input.line_edit.EchoMode.Normal
...
class TestPasswordConfirmInput:
    ...
    def test_password_confirm_input_creation(self, app):
        ...
        assert confirm_input.line_edit.echoMode() == confirm_input.line_edit.EchoMode.Password
