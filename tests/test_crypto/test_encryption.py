...
from src.crypto.encryption import (
    ...
    encrypt_file_with_keyfile, decrypt_file_with_keyfile
)
...
class TestEncryption:
    ...
    def test_encrypt_decrypt_with_password_roundtrip(self):
        ...
        try:
            ...
            # Encrypt
            encrypt_result = encrypt_file_with_password(input_file_path, self.password, encrypted_file_path)
            assert encrypt_result.success is True
            assert encrypt_result.output_path == encrypted_file_path
            
            # Decrypt
            decrypt_result = decrypt_file_with_password(encrypted_file_path, self.password, decrypted_file_path)
    ...
    def test_encrypt_decrypt_with_keyfile_roundtrip(self):
        ...
        try:
            ...
            # Encrypt
            encrypt_result = encrypt_file_with_keyfile(input_file_path, keyfile_path, encrypted_file_path)
            assert encrypt_result.success is True
            assert encrypt_result.output_path == encrypted_file_path
            
            # Decrypt
            decrypt_result = decrypt_file_with_keyfile(encrypted_file_path, keyfile_path, decrypted_file_path)
            assert decrypt_result.success is True
            assert decrypt_result.output_path == decrypted_file_path
            ...
            # Clean up
            for path in [input_file_path, keyfile_path, encrypted_file_path, decrypted_file_path]:
                if os.path.exists(path):
                    os.unlink(path)
    ...
    def test_encrypt_file_with_password_creates_different_output(self):
        ...
        try:
            ...
            encrypt_result1 = encrypt_file_with_password(input_file_path, self.password, encrypted_file1_path)
            assert encrypt_result1.success is True
            
            encrypt_result2 = encrypt_file_with_password(input_file_path, self.password, encrypted_file2_path)
    ...
    def test_decrypt_with_wrong_password_fails(self):
        ...
        try:
            ...
            try:
                decrypt_result = decrypt_file_with_password(encrypted_file_path, wrong_password, decrypted_file_path)
    ...
    def test_encrypt_nonexistent_file_fails(self):
        ...
        result = encrypt_file_with_password(nonexistent_path, self.password, output_path)
    ...
    def test_decrypt_nonexistent_file_fails(self):
        ...
        result = decrypt_file_with_password(nonexistent_path, self.password, output_path)
        assert result.success is False
        assert "File not found" in result.error_message
    ...
    def test_encrypt_with_cleared_password_fails(self):
        ...
        try:
            ...
            result = encrypt_file_with_password(input_file_path, self.password, encrypted_file_path)
            assert result.success is False
    ...
    def test_decrypt_corrupted_file_fails(self):
        ...
        try:
            ...
            result = decrypt_file_with_password(corrupted_file_path, self.password, decrypted_file_path)
            assert result.success is False
