...
from src.utils.validation import (
    validate_password, calculate_password_strength, get_password_requirements,
...
class TestPasswordValidation:
    ...
    def test_validate_password_no_uppercase(self):
        ...
        assert result.is_valid is False
        assert "Password must contain at least one uppercase letter" in result.error_message
    
    def test_validate_password_no_lowercase(self):
        """Test validation of password without lowercase."""
        result = validate_password("MYLONGPASSWORD123!")
        assert result.is_valid is False
        assert "Password must contain at least one lowercase letter" in result.error_message
    ...
    def test_validate_password_no_special_char(self):
        ...
        result = validate_password("MyLongPassword123")
        assert result.is_valid is False
        assert "Password must contain at least one special character" in result.error_message
